# p53 Tumor Suppressor Data Interface (Demo)

This repository serves as a visual demonstration of a web-based data visualization tool built with **Python** and **Streamlit**. 

### 🛠️ Technologies Used:
* **Python** (Pandas, NumPy, Matplotlib)
* **Streamlit** (UI/UX & Data Visualization)
* **Bioinformatics Data Sources** (Clinical datasets)
...
# Figure 2: Real-time Structural Impact Analysis (Wild-Type vs Mutant)
<img width="1825" height="915" alt="demo3" src="https://github.com/user-attachments/assets/a83c91a7-f4bb-4bef-a017-0c3e230d92bb" />

# Figure 4: Automated High-Fidelity PDF Report Generation
<img width="1579" height="857" alt="demo4" src="https://github.com/user-attachments/assets/2644e737-a2ed-4b16-b2ac-8bc7f22dcf87" />
